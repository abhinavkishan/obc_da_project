...
HD_PWD='C:/Vivado Projects/obc_da_project/obc_da_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gaussian_da.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_gaussian_da.tcl
