...
HD_PWD='C:/Vivado Projects/obc_da_project/obc_da_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_gaussian_da.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_gaussian_da.tcl -notrace
